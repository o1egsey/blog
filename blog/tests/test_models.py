...
class PostModelTestCase(TestCase):
    def setUp(self):
        self.user = UserBase.objects.create_user(
            user_name="testuser", email="testuser@example.com", password="testpass"
        )
...
class CommentModelTest(TestCase):
    def setUp(self):
        self.user = UserBase.objects.create_user(
            email="test@test.com", user_name="test_user", password="testpass123"
        )
        self.post = PostModel.objects.create(
            title="Test Post",
...
class ProfileModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = UserBase.objects.create_user(
            email="testuser@test.com", user_name="testuser", password="testpass123"
        )
        test_user.save()
